...
### 1.1 サービスコンセプト
ユーザーが自分の好きなもの（アニメ、ゲーム、キャラクター、食べ物、歌手など）を6行3列のボード形式で整理し、視覚的に表現・共有できるサービス。

### 1.2 類似サービス
- lit.link（ベンチマーク）
- ポケモンタイプごとのすきなポケモン
  - https://x.com/Sylveon_861/status/1991451818254336357

## 2. 用語定義

| 用語 | 定義 |
|------|------|
| キュレーションボード | 6行3列（計18個）のマス目に好きなものを配置したボード |
